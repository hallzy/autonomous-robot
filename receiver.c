...
void pwmcounter (void) interrupt 1
{
  ...
  if (spin == 0) {
    if (++pwmCountRightForward>99) {
      pwmCountRightForward=0;
    }
    P0_3=(pwmRightForward>pwmCountRightForward)?1:0; //P1_0

    if (++pwmCountRightReverse>99) {
      pwmCountRightReverse=0;
    }
    P0_4=(pwmRightReverse>pwmCountRightReverse)?1:0; // P1_1

    if (++pwmCountLeftReverse>99) {
      pwmCountLeftReverse=0;
    }
    P0_2=(pwmLeftReverse>pwmCountLeftReverse)?1:0; // P1_3

    if (++pwmCountLeftForward>99) {
      pwmCountLeftForward=0;
    }
